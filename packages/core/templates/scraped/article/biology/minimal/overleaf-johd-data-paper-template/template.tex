...
Please declare any use of Generative AI tools employed at any stage of the manuscript drafting. For any other use of Generative AI tools, including data acquisition or processing, please follow the publisher’s AI policy (\url{https://ubiquitypress.com/ai-policy}).
