...
%   v2.3    16-03-2026: Double authorship issue fixed
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\documentclass[english,bachelor,groupwork]{hsluthesis} 
...
\secondauthor{Second Author}                          % name of second author: only relevant for groupwork (groupwork flag must be set)
\city{Lucerne (Switzerland) and Bern (Switzerland)}   % author's place of origin; 2nd place only required in the case of doulbe authorship
