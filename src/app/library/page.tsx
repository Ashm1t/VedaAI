  ...
  return (
    <div className="group relative rounded-2xl bg-[#1A1A1A] border border-[#2A2A2A] hover:border-[#333] transition-all hover:shadow-lg hover:shadow-black/30 overflow-hidden">
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, #1DB954 0%, #0f7a33 100%)" }}
      />

      <div className="p-5">
        {/* Subject badge + class badge */}
        <div className="flex items-center gap-2 mb-3">
          <span className="rounded-lg bg-[#1DB954]/10 border border-[#1DB954]/20 px-2.5 py-1 text-[11px] font-semibold text-[#1DB954] uppercase tracking-wide">
            {assignment.subject}
          </span>
  ...
  return (
    <div className="relative">
      <select
        ...
        className="appearance-none rounded-xl bg-[#282828] border border-[#333] text-sm text-white pl-3 pr-8 py-2 focus:outline-none focus:border-[#1DB954] transition-colors cursor-pointer hover:border-[#444]"
      >
        {options.map((o) => (
...
function LibrarySkeleton() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
      {[1, 2, 3, 4, 5, 6].map((i) => (
        <div key={i} className="rounded-2xl bg-[#1A1A1A] border border-[#2A2A2A] overflow-hidden animate-pulse">
