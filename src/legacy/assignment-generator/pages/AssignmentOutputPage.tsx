...
export default function LegacyAssignmentOutputPage() {
  ...
  return (
    <div className="flex flex-col flex-1">
      <Header title="Legacy Assignment Output" showBack />
        ...
        <div className="flex-1 p-8">
          <div className="flex items-center justify-between rounded-2xl bg-[#181818] border border-[#282828] shadow-sm px-6 py-4 mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-[#4C8DFF] px-5 py-2.5 text-sm font-semibold text-black hover:bg-[#3977EA] transition-colors shrink-0 ml-4"
            >
